...
public class TickViewBean {
    public ArrayList<TickViewBean.Data> getDatas() {
        return datas;
    }

    public void setDatas(ArrayList<TickViewBean.Data> datas) {
      this.datas=datas;
    }

    private ArrayList<TickViewBean.Data> datas;
